...
Now, a more interesting and harder question is which IPW estimator should be preferred, classic HT or stabilized HT (also WLS)? It is commonly argued that stabilized HT often has a lower variance than classic HT. A new working paper of Khan and Ugander (2021) explains this phenomenon and very interestingly develope an adaptive approach that finds the most efficient misture of the two estimators in any application. 
